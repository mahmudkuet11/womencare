...
function new_nav_menu_items($items,$args) {
	...
	if (function_exists('icl_get_languages') && $args->theme_location===$wpml_menu) {
		...
		if(1 < count($languages)){
			...
			foreach($languages as $l){
				...
				case 1; //Flag + Native Name
					if($l['active']){
						$items = $items.'<li class="menu-item langflag"><a href="'.$l['url'].'"><img src="'.$l['country_flag_url'].'" height="12" alt="'.$l['language_code'].'" width="18" /> '.$l['native_name'].' </a><ul class="sub-menu">'.wpml_lang_selector_submenu($languages,1).'</ul></li>';         
					}
				break;
				...
				case 2; //Flag + Translated Name
					if($l['active']){
						$items = $items.'<li class="menu-item langflag"><a href="'.$l['url'].'"><img src="'.$l['country_flag_url'].'" height="12" alt="'.$l['language_code'].'" width="18" /> '.$l['translated_name'].' </a><ul class="sub-menu">'.wpml_lang_selector_submenu($languages,2).'</ul></li>';         
					}
				break;
...
function wpml_lang_selector_submenu($languages,$wpml_style){
	...
	foreach($languages as $l){
				...
				case 1; //Flag + Native Name
					if(!$l['active']){
						$items = $items.'<li class="menu-item langflag"><a href="'.$l['url'].'"><img src="'.$l['country_flag_url'].'" height="12" alt="'.$l['language_code'].'" width="18" /> '.$l['native_name'].' </a></li>';         
					}
				break;
				...
				case 2; //Flag + Translated Name
					if(!$l['active']){
						$items = $items.'<li class="menu-item langflag"><a href="'.$l['url'].'"><img src="'.$l['country_flag_url'].'" height="12" alt="'.$l['language_code'].'" width="18" /> '.$l['translated_name'].' </a></li>';         
					}
				break;
