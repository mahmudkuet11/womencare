...
<style type="text/css" media="all">
	...
	body{ font-family: <?php echo str_replace('+', ' ', $font_text['face']); ?>, Helvetica, Arial, sans-serif;
		  ...
		  <?php
			  ...
			  if (get_option('bg_color','#FFFFFF')){
				  echo 'background-color:' .get_option('bg_color','#FFFFFF').' !important;';
			  }
	...
	// SET COLORS  
	$theme_color = get_option('theme_color','#48C8C2');
	$links_color = get_option('links_color','#48C8C2');
	...
	$menu_bg_color = get_option('menu_bg_color','#48C8C2');
	$submenu_bg_color = get_option('submenu_bg_color','#48C8C2');
	...
	$extrapanel_color = get_option('extrapanel_color','#48C8C2');
	$button_color = get_option('button_color','#48C8C2');
	...
	.sf-menu a{ font-size: <?php echo $font_menu['size']; ?>;color: #fff;font-family: <?php echo str_replace('+', ' ', $font_menu['face']); ?>, Arial, Helvetica, sans-serif;font-weight: <?php echo $font_menu['style']; ?>;}
	...
	.head{background-color:<?php echo $header_color; ?>;<?php if (_option('bh_opacity',100)!=100){echo 'background-color:rgba(' . themetor_hex2rgb($header_color).','. themetor_getOpacity(_option('bh_opacity',100)) .');';}?>}
	...
	.headdown{background-color:<?php echo $menu_bg_color; ?> !important;<?php if (_option('sh_opacity',100)!=100){echo 'background-color:rgba(' . themetor_hex2rgb($menu_bg_color).','. themetor_getOpacity(_option('sh_opacity',100)) .') !important;';}?>}
	...
	<?php endif; ?>
	.sf-menu ul li{background-color:<?php echo $submenu_bg_color; ?> !important; <?php if (_option('submenu_opacity',100)!=100){echo 'background-color:rgba(' . themetor_hex2rgb($submenu_bg_color).','. themetor_getOpacity(_option('submenu_opacity',100)) .') !important;';}?>}      
	...
	#footer{background-color:<?php echo $footer_color; ?> !important;
	<?php if (_option('footer_bg_img')){echo 'background-image:url(' . _option('footer_bg_img') .');';} ?>
	}
	
	<?php if(_option('menu_sep',1)==0){?> .sf-menu li:before {content:'' !important;}<?php } ?>
	
	.roundabout ul,.roundabout li {height:<?php echo _option('roundabout_height','260px');?>}
	...
	$cart_c_bg = get_option('cart_c_bg','#48C8C2');
	?>
...
function themetor_getOpacity($p) { 
  return $p/100;
}
