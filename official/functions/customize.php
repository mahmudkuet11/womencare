...
if (!function_exists('color_customize_register')) {
	function color_customize_register($wp_customize){
		...
		// Main Colors ------------------------------------------------
		$colors = array();
		$colors[] = array( 'slug'=>'theme_color', 'default' => '#48C8C2', 'label' => __( 'Theme Color', 'official' ) );
		$colors[] = array( 'slug'=>'bg_color', 'default' => '#FFFFFF', 'label' => __( 'Background Color', 'official' ) );
		$colors[] = array( 'slug'=>'links_color', 'default' => '#48C8C2', 'label' => __( 'Links Color', 'official' ) );
		...
		$colors[] = array( 'slug'=>'button_color', 'default' => '#48C8C2', 'label' => __( 'Buttons Color', 'official' ) );
		...
		$colors[] = array( 'slug'=>'menu_bg_color', 'default' => '#48C8C2', 'label' => __( 'Menu Background Color', 'official' ) );
		$colors[] = array( 'slug'=>'submenu_bg_color', 'default' => '#48C8C2', 'label' => __( 'Sub Menu Background Color', 'official' ) );
		...
		$w_colors[] = array( 'slug'=>'cart_c_bg', 'default' => '#48C8C2', 'label' => __( 'Shopping Cart Counter Background Color', 'official' ) );
