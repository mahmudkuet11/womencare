		...
		jQuery(document).ready(function($) {
			...
			try {
				...
				$("#<?php echo $carousel_id ; ?>").owlCarousel({
						...
						responsive : {0 : {items : 1,nav : false}, 480 : {items : 2}, 769 : {items : <?php echo $thdglkr_cc_col; ?>}}
	...
	<?php if( $wp_query->have_posts() ) :  ?>
    	<?php if ($thdglkr_cc_title!=''){echo do_shortcode('[title]'.$thdglkr_cc_title.'[/title]');} ?>
            ...
            <div class="clients">
              ...
              <ul id="<?php echo $carousel_id ; ?>" class="client-carousel owl-carousel nav_<?php echo $thdglkr_cc_nav; ?>">
