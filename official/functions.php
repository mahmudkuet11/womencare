	...
	function official_register_required_plugins() {
		$plugins = array(
			array(
				...
				'source'   				=> get_template_directory_uri() . '/functions/envato-toolkit/envato-wordpress-toolkit-master.zip',
				'required' 				=> false,
				'version' 				=> '',
...
add_action( 'after_setup_theme', 'official_title_tag_support' );

function official_title_tag_support() {
...
{  
     ...
     if(1 != $pages)
     {
         ...
         if($paged > 2 && $paged > $range+1 && $showitems < $pages) echo "<li><a href='".get_pagenum_link(1)."'>". __('&laquo; First','official') ."</a></li>";
         if($paged > 1 && $showitems < $pages) echo "<li><a href='".get_pagenum_link($paged - 1)."'>". __('&lsaquo; Previous','official') ."</a></li>";
         ...
         if ($paged < $pages && $showitems < $pages) echo "<li><a href='".get_pagenum_link($paged + 1)."'>". __('Next &rsaquo;','official') ."</a></li>";  
         if ($paged < $pages-1 &&  $paged+$range-1 < $pages && $showitems < $pages) echo "<li><a href='".get_pagenum_link($pages)."'>". __('Last &raquo;','official') ."</a></li>";
         echo "</ul></div>\n";
     }
}
