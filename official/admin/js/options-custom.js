...
jQuery(document).ready(function($) {
		...
		if (answer){
			...
			$.post(ajaxurl, data, function(response) {
				...
				else 
				{
					...
					$('#of-option-importing').hide();
					$('#of-option-importdemo').show();
					//alert(response);
	...
	$('#of_set_widgets').live('click', function(){
	
		var answer = confirm("Click OK to set widgets")
		...
		if (answer){
			...
			$.post(ajaxurl, data, function(response) {
				...
				{
					alert(response);
					alert("Your widgets set successfully");
					//location.reload(); 
				}
	...
	$('#of_set_footer_widgets').live('click', function(){
	
		var answer = confirm("Click OK to set Footer widgets")
		...
		if (answer){
			...
			$.post(ajaxurl, data, function(response) {
				...
				{
					alert(response);
					alert("Your Footer widgets set successfully");
					//location.reload(); 
				}
