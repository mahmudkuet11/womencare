<?php 
// Template Name: Portfolio 3 Columns (Masonry)
get_header(); 
    ...
    /* <![CDATA[ */
		...
		function _msnry(m){
			...
			m.masonry({
				...
				isAnimated: true,
				columnWidth: 1,
				<?php if (is_rtl() || _option('rtl_support')){echo'"isOriginLeft": false';}; ?>
			});
